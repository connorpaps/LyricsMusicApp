...
// grabs api data for your country and loads song cards relevant to that country
const AroundYou = () => {
    ...
    useEffect(() => {
        axios.get(`https://geo.ipify.org/api/v2/country?apiKey=at_Rn4ebDEoPasxggfAguuy5YorizenX`)
